...
- Робив би кейси для конкретних аб варіантів, тобто щоб ранити тести на експериментальних варіантах та бути певними що всі вони коректно працюють. Тут маю на увазі запускати тест кейси з примусовим вибором конкретних експериментальних варіантів (localstorage, url params).